...
<?php
$route = 'dir-approve';
$title = 'Flexy App - Director Approve';
...
<body>
        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    <h1 class="h3 mb-3"><strong>Director Panel - Allowance approved</strong></h1>
                    <div class="row">
                        <div class="card">
                            <div class="card-body">
    ...
    <script src="<?= $url . ('/public/flexy-dir/approve.min.js?q=') . time() ?>"></script>
</body>
