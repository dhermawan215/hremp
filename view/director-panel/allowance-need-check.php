...
<body>
        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    <h1 class="h3 mb-3"><strong>Director Panel - Allowance need checked</strong></h1>
                    <div class="row">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="table-dir-need-check" class="table table-striped" style="width:100%">
    ...
    <script src="<?= $url . ('/public/flexy-dir/need-check.min.js?q=') . time() ?>"></script>
</body>
