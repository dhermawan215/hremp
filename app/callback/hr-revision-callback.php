...
<head>
    ...
    <title>HR Allowance Revision Form</title>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h5>HR Allowance Revision Form, Allowance ID: <?= $getToken ?></h5>
                    </div>
                    <?php
                    ...
                    <?php else : ?>
                        <div class="card-body">
                            <form action="" method="post">
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputPassword1" class="form-label">Rejected By</label>
                                    <input name="check" id="check" type="text" class="form-control"></input>
                                </div>
...
if (isset($_POST['token']) && $_POST['action'] == 'revision') {
    ...
    try {
        ...
        $mail->send();
        echo "<script>if(confirm('Allowance Revised')) document.location.href='$url';</script>";
    } catch (Exception $e) {
