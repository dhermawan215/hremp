...
header("Content-Disposition: attachment; filename=Data Pegawai - Pendidikan Karyawan.xls");
...
ON employee.id_employee=education.emp_id WHERE employee.is_resigned=0";
...
<body>
    <h1>Data Karyawan Aktif (Data Pendidikan)</h1>
    <table>
        <thead>
            <tr>
                <th>
