...
header("Content-Disposition: attachment; filename=Data Pegawai - Keluarga Karyawan.xls");
...
ON employee.id_employee=emp_families.emp_id WHERE employee.is_resigned=0";
...
<body>
    <h1>Data Karyawan Aktif (Data Keluarga)</h1>
    <table>
        <thead>
            <tr>
                <th>
