...
header("Content-Disposition: attachment; filename=Data Pegawai - Emergency Karyawan.xls");
...
ON employee.id_employee=emergency.emp_id  WHERE employee.is_resigned=0 ORDER BY nip ASC";
