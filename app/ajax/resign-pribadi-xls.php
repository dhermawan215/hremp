...
header("Content-Disposition: attachment; filename=Data Pegawai Resign.xls");
...
ON employee.id_employee=emp_personal.emp_id WHERE employee.is_resigned=1";
...
<body>
    <h1>Data Karyawan Resign (Data Pribadi)</h1>
    <table>
        <thead>
            <tr>
                <th>
