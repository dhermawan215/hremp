...
header("Content-Disposition: attachment; filename=Data Pegawai Resign - Alamat Karyawan.xls");
...
ON employee.id_employee=emp_personal_address.emp_id WHERE employee.is_resigned=1";
