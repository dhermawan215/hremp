...
-- Dumping data for table hrapp_karyawan.aktivitas: ~0 rows (approximately)

-- Dumping structure for table hrapp_karyawan.allowance
CREATE TABLE IF NOT EXISTS `allowance` (
  `id_allowance` int NOT NULL AUTO_INCREMENT,
  `users_id` int DEFAULT NULL,
  `no` varchar(50) CHARACTER SET utf8mb4 NOT NULL,
  `nama` varchar(50) CHARACTER SET utf8mb4 DEFAULT NULL,
  `departemen` varchar(50) CHARACTER SET utf8mb4 DEFAULT NULL,
...
-- Dumping data for table hrapp_karyawan.allowance: ~0 rows (approximately)
...
-- Dumping data for table hrapp_karyawan.allowance_wallet: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `documents` (
  `id` int NOT NULL AUTO_INCREMENT,
  `file_name` text CHARACTER SET utf8mb4 NOT NULL,
...
-- Dumping data for table hrapp_karyawan.users: ~7 rows (approximately)
INSERT INTO `users` (`id_users`, `employee_id`, `name`, `email`, `roles`, `password`, `active`, `created_at`, `updated_at`) VALUES
	(33, NULL, 'admin', 'support@zekindo.co.id', 1, '$2y$10$EA.G9Kcm3bfrBZ3Iy8NuFe99/PM8BdescdO0eBNdL7.daLz9ctQs6', 'true', '2023-05-11 19:22:33', NULL),
	...
	(36, NULL, 'dicky', 'dicky.hermawan@zekindo.co.id', 3, '$2y$10$EA.G9Kcm3bfrBZ3Iy8NuFe99/PM8BdescdO0eBNdL7.daLz9ctQs6', 'false', '2023-10-03 02:32:42', '2023-10-03 20:04:44'),
	(38, NULL, 'sutrismiyanto', 'sutrismiyanto@zekindo.co.id', 3, '$2y$10$15x7pPsdq4e5LixYYVySdueXKfJkZmqUr1PADC2g2AaKUDsQcOdHG', 'true', '2023-10-03 20:25:46', NULL),
	(39, NULL, 'ridho luthfi', 'ridho.luthfi@acmechem.co.id', 3, '$2y$10$qTb6tCYZuCgGiigYQ7kEM..TNyzePacPISS4JU74X0qRO67GmhIvq', 'true', '2023-10-03 20:27:12', NULL),
	(40, NULL, 'Yana Marlianty', 'yana@zekindo.com', 2, '$2y$10$kSBUHYkL1GQHXwZhHKp/RuAgTxrd9rAIcsI4Y4ntrFpFETxj9VAE.', 'true', '2023-11-16 07:16:02', NULL),
	(41, NULL, 'Gabriela Carissa', 'gabriela.carissa@zekindo.co.id', 2, '$2y$10$BhdZyes70uXmDOAZEzBev.WXTpapj.W0Vr8YoBmqNizp5UWNFrY3u', 'true', '2023-12-11 08:33:49', NULL);
